...
之前我使用桌面版本Qt实现了肺炎疫情监控平台：[基于Qt的新冠肺炎疫情数据实时监控平台（开源小项目）](https://blog.csdn.net/whik1194/article/details/104300691)。
...
接口地址的获取方法可以参考：[基于Qt的新冠肺炎疫情数据实时监控平台（开源小项目）](https://blog.csdn.net/whik1194/article/details/104300691)
