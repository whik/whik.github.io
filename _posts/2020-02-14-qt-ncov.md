...
界面也很简单，主要包括实时数据和历史数据的显示，实时疫情动态信息的显示，辟谣的展示，数据来自腾讯新闻，UI设计参考了腾讯新闻的界面。

![](https://wcc-blog.oss-cn-beijing.aliyuncs.com/img/qt_2019_ncov/1_%E4%B8%BB%E7%95%8C%E9%9D%A2.jpg)

两个数据接口来自腾讯新闻，一个是包括实时数据、历史数据和疫情动态的接口，一个是包含辟谣信息的接口。
...
我们访问这样一个地址： https://vp.fact.qq.com/miniArtData?id=a2141851348ee5f3772c761e25bb57d7 ，就会得到这条谣言新闻的JSON格式详细信息，如下：
